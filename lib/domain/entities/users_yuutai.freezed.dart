...
mixin _$UsersYuutai {
 ...
 int? get id;@JsonKey(name: 'company_name') String get companyName;@JsonKey(name: 'company_id') int? get companyId;@JsonKey(name: 'benefit_detail') String? get benefitDetail;@JsonKey(name: 'expiry_date') DateTime? get expiryDate; BenefitStatus get status;@JsonKey(name: 'alert_enabled') bool get alertEnabled; String? get notes;@JsonKey(name: 'notify_days_before') List<int>? get notifyDaysBefore;@JsonKey(name: 'folder_id') String? get folderId;
...
/// Create a copy of UsersYuutai
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = freezed,Object? companyName = null,Object? companyId = freezed,Object? benefitDetail = freezed,Object? expiryDate = freezed,Object? status = null,Object? alertEnabled = null,Object? notes = freezed,Object? notifyDaysBefore = freezed,Object? folderId = freezed,}) {
...
as List<int>?,folderId: freezed == folderId ? _self.folderId : folderId // ignore: cast_nullable_to_non_nullable
as String?,
  ));
}
...
switch (_that) {
case _UsersYuutai() when $default != null:
return $default(_that.id,_that.companyName,_that.companyId,_that.benefitDetail,_that.expiryDate,_that.status,_that.alertEnabled,_that.notes,_that.notifyDaysBefore,_that.folderId);case _:
  return orElse();
...
class _UsersYuutai extends UsersYuutai {
  const _UsersYuutai({this.id, @JsonKey(name: 'company_name') this.companyName = '', @JsonKey(name: 'company_id') this.companyId, @JsonKey(name: 'benefit_detail') this.benefitDetail, @JsonKey(name: 'expiry_date') this.expiryDate, this.status = BenefitStatus.active, @JsonKey(name: 'alert_enabled') this.alertEnabled = false, this.notes, @JsonKey(name: 'notify_days_before') final  List<int>? notifyDaysBefore, @JsonKey(name: 'folder_id') this.folderId}): _notifyDaysBefore = notifyDaysBefore,super._();
...
@override@JsonKey(name: 'notify_days_before') List<int>? get notifyDaysBefore {
  final value = _notifyDaysBefore;
  if (value == null) return null;
  if (_notifyDaysBefore is EqualUnmodifiableListView) return _notifyDaysBefore;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _UsersYuutai&&(identical(other.id, id) || other.id == id)&&(identical(other.companyName, companyName) || other.companyName == companyName)&&(identical(other.companyId, companyId) || other.companyId == companyId)&&(identical(other.benefitDetail, benefitDetail) || other.benefitDetail == benefitDetail)&&(identical(other.expiryDate, expiryDate) || other.expiryDate == expiryDate)&&(identical(other.status, status) || other.status == status)&&(identical(other.alertEnabled, alertEnabled) || other.alertEnabled == alertEnabled)&&(identical(other.notes, notes) || other.notes == notes)&&const DeepCollectionEquality().equals(other._notifyDaysBefore, _notifyDaysBefore)&&(identical(other.folderId, folderId) || other.folderId == folderId));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,companyName,companyId,benefitDetail,expiryDate,status,alertEnabled,notes,const DeepCollectionEquality().hash(_notifyDaysBefore),folderId);
...
/// Create a copy of UsersYuutai
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = freezed,Object? companyName = null,Object? companyId = freezed,Object? benefitDetail = freezed,Object? expiryDate = freezed,Object? status = null,Object? alertEnabled = null,Object? notes = freezed,Object? notifyDaysBefore = freezed,Object? folderId = freezed,}) {
...
as BenefitStatus,alertEnabled: null == alertEnabled ? _self.alertEnabled : alertEnabled // ignore: cast_nullable_to_non_nullable
as bool,notes: freezed == notes ? _self.notes : notes // ignore: cast_nullable_to_non_nullable
as String?,notifyDaysBefore: freezed == notifyDaysBefore ? _self._notifyDaysBefore : notifyDaysBefore // ignore: cast_nullable_to_non_nullable
as List<int>?,folderId: freezed == folderId ? _self.folderId : folderId // ignore: cast_nullable_to_non_nullable
as String?,
  ));
}
