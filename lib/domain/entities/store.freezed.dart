...
mixin _$Store {
 ...
 int get id; String get name;@JsonKey(name: 'lat') double get latitude;@JsonKey(name: 'lng') double get longitude;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Store&&(identical(other.id, id) || other.id == id)&&(identical(other.name, name) || other.name == name)&&(identical(other.latitude, latitude) || other.latitude == latitude)&&(identical(other.longitude, longitude) || other.longitude == longitude));
}
...
@useResult
$Res call({
 int id, String name,@JsonKey(name: 'lat') double latitude,@JsonKey(name: 'lng') double longitude
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int id,  String name, @JsonKey(name: 'lat')  double latitude, @JsonKey(name: 'lng')  double longitude)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Store() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int id,  String name, @JsonKey(name: 'lat')  double latitude, @JsonKey(name: 'lng')  double longitude)  $default,) {final _that = this;
switch (_that) {
case _Store():
return $default(_that.id,_that.name,_that.latitude,_that.longitude);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int id,  String name, @JsonKey(name: 'lat')  double latitude, @JsonKey(name: 'lng')  double longitude)?  $default,) {final _that = this;
switch (_that) {
case _Store() when $default != null:
return $default(_that.id,_that.name,_that.latitude,_that.longitude);case _:
  return null;
...
class _Store implements Store {
  const _Store({required this.id, required this.name, @JsonKey(name: 'lat') required this.latitude, @JsonKey(name: 'lng') required this.longitude});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Store&&(identical(other.id, id) || other.id == id)&&(identical(other.name, name) || other.name == name)&&(identical(other.latitude, latitude) || other.latitude == latitude)&&(identical(other.longitude, longitude) || other.longitude == longitude));
}
